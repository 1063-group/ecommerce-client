      ...
      <div className="flex bg-base-100 min-w-[220px] rounded-xl m-5">
        ...
        <div className="flex bg-base-100 rounded-xl flex-col justify-between p-4">
          ...
          <div className="buy flex justify-between items-center">
            <button className="px-3 py-3  border-3 text-2xl text-primary rounded-xl hover:bg-primary/20 transition">
              <FiShoppingCart />
            </button>
            ...
            <Link
              to={`/products/${product.id}`}
              className="text-xl text-secondary  border-3 rounded-xl px-7 py-2 hover:bg-secondary/20 transition"
            >
              В рассрочку
            </Link>
          </div>
